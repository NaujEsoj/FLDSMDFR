          ...
          <div className='flex justify-around items-center'>
            <div className='flex flex-col'>
              ...
              <div className="btn-group flex justify-center">
                <input type="radio" name="options" data-title="ES" className="btn" onClick={handleES} />
                <input type="radio" name="options" data-title="EN" className="btn" onClick={handleEN} />
                <input type="radio" name="options" data-title="FR" className="btn" onClick={handleFR} />
                <input type="radio" name="options" data-title="PT" className="btn" onClick={handlePT} />
              </div>
            </div>
        ...
        <div className='m-1 block'>
          ...
          <div className='flex justify-center items-center'>
            ...
            <div className='flex flex-col'>
              ...
              <div className="btn-group flex justify-center">
                <input type="radio" name="options2" data-title="USD" value={'USD'} className="btn" onClick={() => setMoneySymbol('USD ')} />
                <input type="radio" name="options2" data-title="$" value={'$'} className="btn" onClick={() => setMoneySymbol('$')} />
              </div>
            </div>
          </div>
